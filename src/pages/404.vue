<template>
    <div class="flex items-center justify-center min-h-screen bg-skyBlue-900 bg-fixed bg-cover bg-bottom error-bg"
            ...
            <div class="row">
                <div class="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
                    <div class="relative ">
                        ...
                        <span class="absolute  top-0   -ml-12  text-gray-100 font-semibold">Oops!</span>
                    </div>
                    <h5 class="text-gray-50 font-semibold -mr-10 -mt-3">Page not found</h5>
                    <p class="text-gray-50 mt-2 mb-6">we are sorry, but the page you requested was not found</p>
                    <router-link to="/"
                        class="bg-green-700  px-5 py-3 text-sm shadow-sm font-medium tracking-wider text-gray-50 rounded-full hover:shadow-lg">
                        Got to Home
                    </router-link>
                </div>
            </div>
...
useHead({
    title: '404 Page - Finance Omoyetips',
    meta: [
        {
            name: 'description',
            content: '404 Page, Not Found - Finance Omoyetips'
        },
    ],
    link: [{
