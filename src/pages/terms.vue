<template>
    <div class="ccontainer mx-auto p-4 max-w-screen-lg md:mx-3 lg:mx-auto font-mukha text-gray-600 leading-6">
        <h1 class="text-4xl my-6 text-gray-800">Terms and Conditions</h1>
        <h2 class="text-2xl my-2 text-gray-800">Welcome to omoyetips!</h2>

        <p class="my-4">
            These terms and conditions outline the rules and regulations for the use of Chief Media's Website, located at
            https://betting.omoyetips.com.
        </p>

        <p class="my-4">
            By accessing this website, we assume you accept these terms and conditions. Do not continue to use omoyetipss if
            you do
        ...
        <p class="my-4">
            Cookies:
            The website uses cookies to help personalize your online experience. By accessing omoyetipss, you agreed to use
            the
            required cookies.
        </p>

        <p class="my-4">A cookie is a text file that is placed on your hard disk by a web page server. Cookies cannot be
            used to run
            programs or
        ...
        <p class="my-4"> We may use cookies to collect, store, and track information for statistical or marketing purposes
            to operate our
            website. You have the ability to accept or decline optional Cookies. There are some required Cookies that are
            necessary
            for the operation of our website. These cookies do not require your consent as they always work. Please keep in
            mind
            that by accepting required Cookies, you also accept third-party Cookies, which might be used via third-party
            provided
            services if you use such services on our website, for example, a video display window provided by third parties
            and
            integrated into our website.</p>

        <p class="my-4">
            License:
            Unless otherwise stated, Chief Media and/or its licensors own the intellectual property rights for all material
            on
            omoyetipss. All intellectual property rights are reserved. You may access this from omoyetipss for your own
            personal use
            subjected to restrictions set in these terms and conditions.
        </p>

        <h2 class="text-2xl my-5 text-gray-800">You must not:</h2>

        <p class="my-4">
            Copy or republish material from omoyetipss
            Sell, rent, or sub-license material from omoyetipss
            Reproduce, duplicate or copy material from omoyetipss
            Redistribute content from omoyetipss
            This Agreement shall begin on the date hereof.
        </p>

        <p class="my-4">
            Parts of this website offer users an opportunity to post and exchange opinions and information in certain areas
            of the
            website. Chief Media does not filter, edit, publish or review Comments before their presence on the website.
            Comments do
            not reflect the views and opinions of Chief Media, its agents, and/or affiliates. Comments reflect the views and
            opinions of the person who posts their views and opinions. To the extent permitted by applicable laws, Chief
            Media shall
            not be liable for the Comments or any liability, damages, or expenses caused and/or suffered as a result of any
            use of
            and/or posting of and/or appearance of the Comments on this website.
        </p>

        <p class="my-4">
            Chief Media reserves the right to monitor all Comments and remove any Comments that can be considered
            inappropriate,
            offensive, or causes breach of these Terms and Conditions.
        </p>

        <h2 class="text-2xl my-5 text-gray-800">
        ...
        <h3 class="text-2xl my-3 text-gray-800">
        ...
        <p class="my-4">
            ...
            records
            with
            us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Chief Media; and (d)
            the
            link
        ...
        <p class="my-4">
            ...
            falsely
            imply sponsorship, endorsement, or approval of the linking party and its products or services; and (c) fits
            within
            the
        ...
        <p class="my-4">
            ...
            you
            must
            inform us by sending an e-mail to Chief Media. Please include your name, your organization name, contact
            information
            as
        ...
        <h3 class="text-2xl my-2 text-gray-800">
        ...
        No use of Chief Media's logo or other artwork will be allowed for linking absent a trademark license agreement.
        ...
        <p class="my-4">
            ...
            conditions
            and its linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow
            these
...
export default {
    ...
    setup() {
        useHead({
            title: 'Terms and condictions - Betting Omoyetips',
            meta: [
                {
                    name: 'description',
                    content: 'Read our terms of service - Betting Omoyetips'
                },
            ],
            link: [{
